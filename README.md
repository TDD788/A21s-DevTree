...
**#Orange Fox Device configuration for Samsung Galaxy A21s Nacho / A21s**
...
*## Base Version*
```
A217MUBUBDWK2-A217FXXSADWK2
```

**## Build**
```
source build/envsetup.sh; export ALLOW_MISSING_DEPENDENCIES=true; lunch twrp_A21s-eng; mka recoveryimage
```

**## Device Image**

![Samsung Galaxy A21s Nacho](https://github.com/TDD788/A21s-DevTree/blob/DT-Builder/.github/pictures/device-png-a12s.jpg)
